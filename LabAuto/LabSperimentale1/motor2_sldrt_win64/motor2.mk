...
MODEL                := motor2
MODULES              := motor2_data.c motor2_tgtconn.c rtGetInf.c rtGetNaN.c rt_nonfinite.c
MAKEFILE             := motor2.mk
...
MODELLIB                  := 
MODELREF_LINK_LIBS        := 
MODELREF_LINK_RSPFILE     := motor2_ref.rsp
...
# additional includes
REQ_INCLUDES += ;C:/Users/saporitife/Documents/MATLAB/LabSperimentale1;C:/Users/saporitife/Documents/MATLAB/LabSperimentale1/motor2_sldrt_win64;$(MATLAB_ROOT)/extern/include;$(MATLAB_ROOT)/simulink/include;$(MATLAB_ROOT)/rtw/c/src;$(MATLAB_ROOT)/rtw/c/src/ext_mode/common;$(MATLAB_ROOT)/toolbox/coder/rtiostream/src
