...
#ifndef RTW_HEADER_motor2_h_
#define RTW_HEADER_motor2_h_
#ifndef motor2_COMMON_INCLUDES_
#define motor2_COMMON_INCLUDES_
#include "rtwtypes.h"
#include "simstruc.h"
...
#include "ext_work.h"
#include "sldrtdef.h"
#endif                                 /* motor2_COMMON_INCLUDES_ */

#include "motor2_types.h"
#include "rtGetNaN.h"
...
#define motor2_rtModel                 RT_MODEL_motor2_T
...
#define rtB                            motor2_B
#define BlockIO                        B_motor2_T
#define rtX                            motor2_X
#define ContinuousStates               X_motor2_T
#define rtXdot                         motor2_XDot
#define StateDerivatives               XDot_motor2_T
#define tXdis                          motor2_XDis
#define StateDisabled                  XDis_motor2_T
#define rtP                            motor2_P
#define Parameters                     P_motor2_T
#define rtDWork                        motor2_DW
#define D_Work                         DW_motor2_T
...
struct P_motor2_T_ {
  struct_8LnTg2HasR61N4e63tMdJ sens;   /* Variable: sens
                                        ...
                                        *   '<Root>/Gain8'
                                        */
  struct_hqe83yBAMISEn9IXxbwOKF ff;    /* Variable: ff
                                        * Referenced by:
                                        *   '<Root>/Gain16'
                                        *   '<Root>/Gain19'
                                        *   '<Root>/Gain20'
                                        ...
                                        *   '<Root>/Gain24'
                                        */
  struct_zh0Jahtydja9slL4vn0KNB diff;  /* Variable: diff
                                        * Referenced by:
                                        *   '<Root>/Constant'
                                        *   '<Root>/Gain7'
                                        */
  struct_tOQDypDRbFi5SWlJtRB3OB dac;   /* Variable: dac
                                        * Referenced by: '<Root>/Saturation2'
                                        */
  struct_vJJjEYOykwYuBPVflT2NUH awu;   /* Variable: awu
                                        * Referenced by:
                                        *   '<Root>/Gain14'
                                        *   '<Root>/Gain15'
                                        */
  struct_xYTLf9xRBpYnquzooZvpnD pid;   /* Variable: pid
                                        * Referenced by:
                                        *   '<Root>/Gain11'
                                        *   '<Root>/Gain13'
                                        */
  ...
  real_T Step_Y0;                      /* Expression: 0
                                        * Referenced by: '<Root>/Step'
                                        */
  real_T Step_YFinal;                  /* Expression: 450
                                        * Referenced by: '<Root>/Step'
                                        */
...
extern P_motor2_T motor2_P;

/* Block signals (default storage) */
extern B_motor2_T motor2_B;

/* Continuous states (default storage) */
extern X_motor2_T motor2_X;

/* Block states (default storage) */
extern DW_motor2_T motor2_DW;

/* Model entry point functions */
extern void motor2_initialize(void);
extern void motor2_output(void);
extern void motor2_update(void);
extern void motor2_terminate(void);

/*====================*
 * External functions *
 *====================*/
extern motor2_rtModel *motor2(void);
...
extern RT_MODEL_motor2_T *const motor2_M;
 ...
 *
 * '<Root>' : 'motor2'
 * '<S1>'   : 'motor2/Repeating Sequence Stair'
 * '<S2>'   : 'motor2/Repeating Sequence Stair/LimitedCounter'
 * '<S3>'   : 'motor2/Repeating Sequence Stair/LimitedCounter/Increment Real World'
 * '<S4>'   : 'motor2/Repeating Sequence Stair/LimitedCounter/Wrap To Zero'
 */
#endif                                 /* RTW_HEADER_motor2_h_ */
