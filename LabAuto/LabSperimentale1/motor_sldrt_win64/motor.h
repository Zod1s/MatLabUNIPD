 ...
 * C source code generated on : Mon May 15 14:10:55 2023
 *
...
#define motor_rtModel                  RT_MODEL_motor_T
...
#define rtB                            motor_B
#define BlockIO                        B_motor_T
#define rtX                            motor_X
#define ContinuousStates               X_motor_T
#define rtXdot                         motor_XDot
#define StateDerivatives               XDot_motor_T
#define tXdis                          motor_XDis
#define StateDisabled                  XDis_motor_T
#define rtP                            motor_P
#define Parameters                     P_motor_T
#define rtDWork                        motor_DW
#define D_Work                         DW_motor_T
...
struct P_motor_T_ {
  ...
  uint8_T LimitedCounter_uplimit;      /* Mask Parameter: LimitedCounter_uplimit
                                        ...
                                        */
  real_T Gain15_Gain;                  /* Expression: triang.A
                                        * Referenced by: '<Root>/Gain15'
                                        */
  real_T SignalGenerator_Amplitude;    /* Expression: step.A
                                        * Referenced by: '<Root>/Signal Generator'
                                        */
  real_T SignalGenerator_Frequency;    /* Expression: 1 / step.T
                                        * Referenced by: '<Root>/Signal Generator'
                                        */
  real_T Gain14_Gain;                  /* Expression: stair.dw
 ...
 * External functions *
 *====================*/
extern motor_rtModel *motor(void);
 ...
 *
 * '<Root>' : 'motor'
 * '<S1>'   : 'motor/Repeating Sequence'
 * '<S2>'   : 'motor/Repeating Sequence Stair'
 * '<S3>'   : 'motor/Repeating Sequence Stair/LimitedCounter'
 * '<S4>'   : 'motor/Repeating Sequence Stair/LimitedCounter/Increment Real World'
 * '<S5>'   : 'motor/Repeating Sequence Stair/LimitedCounter/Wrap To Zero'
 */
