...
MODEL                := motor
MODULES              := motor_data.c motor_tgtconn.c rtGetInf.c rtGetNaN.c rt_nonfinite.c
MAKEFILE             := motor.mk
...
# additional includes
REQ_INCLUDES += ;Z:/windows_profile/Documenti/MATLAB/temp/LabAuto/LabSperimentale1;Z:/windows_profile/Documenti/MATLAB/temp/LabAuto/LabSperimentale1/motor_sldrt_win64;$(MATLAB_ROOT)/extern/include;$(MATLAB_ROOT)/simulink/include;$(MATLAB_ROOT)/rtw/c/src;$(MATLAB_ROOT)/rtw/c/src/ext_mode/common;$(MATLAB_ROOT)/toolbox/coder/rtiostream/src
