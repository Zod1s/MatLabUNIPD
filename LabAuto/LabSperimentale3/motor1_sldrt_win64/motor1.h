...
#ifndef RTW_HEADER_motor1_h_
#define RTW_HEADER_motor1_h_
#ifndef motor1_COMMON_INCLUDES_
#define motor1_COMMON_INCLUDES_
#include "rtwtypes.h"
#include "simstruc.h"
...
#include "ext_work.h"
#include "sldrtdef.h"
#endif                                 /* motor1_COMMON_INCLUDES_ */

#include "motor1_types.h"
#include "rtGetInf.h"
#include <stddef.h>
#include <string.h>
...
#define motor1_rtModel                 RT_MODEL_motor1_T
...
#define rtB                            motor1_B
#define BlockIO                        B_motor1_T
#define rtX                            motor1_X
#define ContinuousStates               X_motor1_T
#define rtXdot                         motor1_XDot
#define StateDerivatives               XDot_motor1_T
#define tXdis                          motor1_XDis
#define StateDisabled                  XDis_motor1_T
#define rtP                            motor1_P
#define Parameters                     P_motor1_T
#define rtDWork                        motor1_DW
#define D_Work                         DW_motor1_T
...
struct P_motor1_T_ {
  ...
  int32_T AnalogOutput_VoltRange;      /* Mask Parameter: AnalogOutput_VoltRange
                                        * Referenced by: '<Root>/Analog Output'
                                        */
  real_T Step_Time;                    /* Expression: step.T
                                        * Referenced by: '<Root>/Step'
                                        */
  real_T Step_Y0;                      /* Expression: 0
                                        * Referenced by: '<Root>/Step'
                                        */
  real_T Step_YFinal;                  /* Expression: step.A
                                        * Referenced by: '<Root>/Step'
                                        */
...
extern P_motor1_T motor1_P;

/* Block signals (default storage) */
extern B_motor1_T motor1_B;

/* Continuous states (default storage) */
extern X_motor1_T motor1_X;

/* Block states (default storage) */
extern DW_motor1_T motor1_DW;

/* Model entry point functions */
extern void motor1_initialize(void);
extern void motor1_output(void);
extern void motor1_update(void);
extern void motor1_terminate(void);

/*====================*
 * External functions *
 *====================*/
extern motor1_rtModel *motor1(void);
...
extern RT_MODEL_motor1_T *const motor1_M;
