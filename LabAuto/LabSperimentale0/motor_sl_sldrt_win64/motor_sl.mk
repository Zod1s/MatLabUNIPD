...
MODEL                := motor_sl
MODULES              := motor_sl_data.c motor_sl_tgtconn.c rtGetInf.c rtGetNaN.c rt_nonfinite.c
MAKEFILE             := motor_sl.mk
...
MODELLIB                  := 
MODELREF_LINK_LIBS        := 
MODELREF_LINK_RSPFILE     := motor_sl_ref.rsp
...
# additional includes
REQ_INCLUDES += ;Z:/windows_profile/Documenti/MATLAB/temp/LabAuto;Z:/windows_profile/Documenti/MATLAB/temp/LabAuto/motor_sl_sldrt_win64;$(MATLAB_ROOT)/extern/include;$(MATLAB_ROOT)/simulink/include;$(MATLAB_ROOT)/rtw/c/src;$(MATLAB_ROOT)/rtw/c/src/ext_mode/common;$(MATLAB_ROOT)/toolbox/coder/rtiostream/src
