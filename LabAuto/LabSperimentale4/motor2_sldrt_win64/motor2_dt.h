...
static DataTypeTransition rtBTransitions[] = {
  { (char_T *)(&motor2_B.Step), 0, 0, 11 }
  ,

  { (char_T *)(&motor2_DW.DiscreteTransferFcn_states[0]), 0, 0, 5 },

  { (char_T *)(&motor2_DW.EncoderInput_PWORK), 11, 0, 10 }
};
...
static DataTypeTransition rtPTransitions[] = {
  { (char_T *)(&motor2_P.sens), 21, 0, 1 },

  { (char_T *)(&motor2_P.dac), 24, 0, 1 },

  { (char_T *)(&motor2_P.step), 25, 0, 1 },

  { (char_T *)(&motor2_P.awu), 23, 0, 1 },

  { (char_T *)(&motor2_P.pid), 22, 0, 1 },

  { (char_T *)(&motor2_P.degs2rpm), 0, 0, 17 },

  { (char_T *)(&motor2_P.EncoderInput_Channels), 6, 0, 8 },

  { (char_T *)(&motor2_P.Step_Y0), 0, 0, 5 }
};
