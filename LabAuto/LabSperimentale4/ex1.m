...
hold on
grid on
plot(T3_TU_resp.time, T3_TU_resp.signals(3).values)
...
hold on
grid on
plot(T3_TU_resp.time, T3_TU_resp.signals(4).values)
...
hold on
grid on
stairs(T3_TU_resp.time, T3_TU_resp.signals(5).values)
plot(T3_TU_resp.time, T3_TU_resp.signals(1).values)
...
hold on
grid on
plot(T3_TU_resp.time, T3_TU_resp.signals(2).values)
...
hold on
grid on
plot(T3_TU_resp.time, T3_TU_resp.signals(7).values)
